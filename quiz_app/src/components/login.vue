<template>
    ...
    <div id="outerlogincontainer" class="absolute top-2/4 left-2/4 translate-y-[-50%] translate-x-[-50%] m-0 select-none"> 
        <div id="logincontainer" class="flex flex-col justify-between h-[350px] w-[400px] border-2 border-black rounded-lg"> 
            ...
            <button class="loginbutton w-11/12 mx-4 p-4 mb-8 tracking-widest bg-blue-500 border-2 border-blue-500 hover:bg-white hover:text-blue-900"
                    @click="loginAction"
            >
                    LOGIN
            </button> 
